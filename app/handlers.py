...
from src.agent_sentinel.pdfkt import PdfFactory, PdfTitle, PdfMarkDownBody
import datetime
import shutil
...
async def handoff(
    ...
    if repo_url is not None:
        ...
        tool_args['paths'] = [
            path for path in tool_args['paths']
    ...
    pdf = PdfFactory(
        ...
        footer_text="Generated by Sentinel agent",
        page_number=True
    )
    ...
    try:
        ...
        with open(f"{tempdir}/report.html", "w") as f:
            f.write(html)
